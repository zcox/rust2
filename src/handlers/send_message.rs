...
use crate::sse::{
    create_agent_text_event, create_done_event, create_tool_call_event, create_tool_result_event,
};
            ...
            match event_result {
                Ok(agent_event) => match agent_event {
                    ...
                    AgentEvent::TextDelta(text) => {
                        create_agent_text_event(thread_id.to_string(), msg_id, text)
                    }
                    ...
                    AgentEvent::ToolExecutionStarted {
                        ...
                        name,
                        input,
                    } => create_tool_call_event(tool_use_id.clone(), name, input),

                    // Map tool execution completed to tool_result SSE events
                    ...
                    // Map tool execution failed to tool_result SSE events with error
